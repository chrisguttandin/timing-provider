...
describe('waitForEvent', () => {
    ...
    beforeEach(() => {
        ...
        fakeEventTarget = {
            addEventListener: stub()
                .callsFake((_, listener) => { fakeEventTargetListener = listener; }),
    ...
    describe('without any emitted event', () => {
        ...
        describe('without unsubscribing', () => {
            ...
            it('should not emit a value', marbles((helpers) => {
    ...
    describe('with an emitted event at 20ms', () => {
        ...
        it('should emit the value', marbles((helpers) => {
            const expected = helpers.cold('--(a|)', { a: fakeEventTarget });
            const destination = merge(
                helpers
                    .cold('--|')
                    .pipe(finalize(() => fakeEventTargetListener())),
